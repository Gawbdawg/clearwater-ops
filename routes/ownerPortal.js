  ...
  const enriched = appts
    .map((a) => {
      ...
      return {
        ...
        // completed (an in-progress/scheduled job's notes field is either empty or
        // not meant for the owner yet). Chemistry readings (chlorine/pH/alkalinity)
        // are deliberately never included here — same office-only boundary as the
        // Home tab's briefing card.
