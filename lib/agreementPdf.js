...
function buildAgreementPdf(owner, properties) {
  ...
  doc.fontSize(16).font('Helvetica-Bold').text('Clear Water Spa Service', { align: 'center' });
  doc.moveDown(0.3);
  ...
  doc.fontSize(8).fillColor('#666').text(
    `This record reflects an electronic agreement captured by Clear Water Spa Service's owner portal. Generated ${new Intl.DateTimeFormat('en-US', { timeZone: BUSINESS_TIMEZONE, dateStyle: 'medium', timeStyle: 'short' }).format(new Date())} (Pacific time).`,
  );
