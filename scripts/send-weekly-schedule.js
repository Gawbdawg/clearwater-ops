...
//
// Env vars:
//   APP_BASE_URL        Base URL of the deployed app, e.g. https://clearwater-ops.onrender.com
...
//   OWNER_EMAIL          Where the full weekly schedule goes (defaults to clearwaterspaservice@gmail.com)
...
const OWNER_EMAIL = process.env.OWNER_EMAIL || 'clearwaterspaservice@gmail.com';
...
async function main() {
  ...
  const ownerText = buildWeekText(weekAppts, `Clear Water Spa Service — Week of ${niceDate(startStr)}`, null);
  await sendEmail({
    to: OWNER_EMAIL,
