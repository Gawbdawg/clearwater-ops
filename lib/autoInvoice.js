...
function maybeCreateInvoiceForCompletedAppointment(appt) {
  ...
  return store.create('invoices', {
    ...
    dueDate: '',
    status: 'draft',
    notes: `Auto-generated from completed appointment (${service.name}${priceNote})${addonsNote(appt)}.`,
  });
}

module.exports = { maybeCreateInvoiceForCompletedAppointment, resolvePrice, addonsTotal, addonsNote };
