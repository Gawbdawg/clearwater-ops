...
const COLLECTIONS = ['customers', 'owners', 'technicians', 'appointments', 'invoices', 'bookings', 'serviceRequests', 'admins', 'services', 'addons', 'techTimeOff'];
...
function buildDefaultData() {
  const data = {
    ...
    nextId: { customers: 1, owners: 1, technicians: 1, appointments: 1, invoices: 1, bookings: 1, serviceRequests: 1, admins: 1, services: 1, addons: 1, techTimeOff: 1 },
  };
